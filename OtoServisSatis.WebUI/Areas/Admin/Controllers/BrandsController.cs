...
{
    [Area("Admin"), Authorize(Policy = "AdminPolicy")] // Not: Bu controller sadece Admin rolüne sahip kullanıcılar tarafından erişilebilir.
    public class BrandsController : Controller
    {
        ...
        public async Task<ActionResult> CreateAsync(Marka marka)
        {
            ...
            {
               ModelState.AddModelError("", "Marka eklenirken bir hata oluştu.");
            }
            return View(marka);
        }
